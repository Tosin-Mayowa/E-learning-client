...
import { IOption, OptionType } from "../Components/SignUpComp/SignUpComp";

type IRegister={
    fullName:string,
    stateVal:OptionType|null,
  ...
  | { type: 'SET_STATE_VAL'; payload: OptionType|null }
  | { type: 'SET_COUNTRY'; payload: IOption | null }
  | { type: 'SET_GENDER'; payload: OptionType|null }
